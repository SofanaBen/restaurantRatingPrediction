...
class DataIngestion:
    ...
    def download_restaurant_rating_data(self,) -> str:
        try:
            ...
            restaurant_rating_file_name = os.path.basename(download_url)
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            # with tarfile.open(tgz_file_path) as restaurant_rating_tgz_file_obj:
            # restaurant_rating_tgz_file_obj.extractall(path=raw_data_dir)
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            restaurant_rating_file_path = os.path.join(raw_data_dir,file_name)
            ...
            for train_index,test_index in splits.split(restaurant_rating_data_frame, restaurant_rating_data_frame["Rating"]):
                strat_train_set = restaurant_rating_data_frame.loc[train_index].drop(["Rating"],axis=1)
                strat_test_set = restaurant_rating_data_frame.loc[test_index].drop(["Rating"],axis=1)
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        try:
            tgz_file_path =  self.download_restaurant_rating_data()
