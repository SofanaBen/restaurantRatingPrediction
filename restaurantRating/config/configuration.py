...
from restaurantRating.entity.config_entity import DataIngestionConfig,TrainingPipelineConfig, DataValidationConfig
...
# It reads the yaml file and gives it back to you
    def __init__(self,
